...
router.post("/addosd", (req, res) => {
    const data = req.body;

    const q = `
    INSERT INTO osd (traineeId, startDate, endDate, postedTo, approvedBy, remarks, addedBy, courseName, recStatus)
    VALUES (
        '${data.traineeId}',
        '${data.startDate}',
...
router.get("/getosd", (req, res) => {
    const q = `SELECT * FROM osd`;
...
router.put("/updateosd/:id", (req, res) => {
